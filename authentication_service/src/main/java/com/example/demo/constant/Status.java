...
public class Status {
    ...
    public static final Integer ACCOUNT_LOGIN_FAIL = 1;
    public static final Integer ACCOUNT_DUPLICATED = 2;
    ...
    static {
        ...
        StatusMap.put(ACCOUNT_LOGIN_FAIL, "error.account.login.fail");
        StatusMap.put(ACCOUNT_DUPLICATED, "error.account.duplicated");
